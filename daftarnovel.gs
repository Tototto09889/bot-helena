...
const daftarNovel = {
  ...
  "A": [
    ...
    {
      judul: "Arifureta Shokugyou De Sekai", // Judul diubah
      keyword: "arifureta",
  ...
  "B": [
    {
      judul: "Battle Divas", // Judul diubah
      keyword: "battle",
    ...
    {
      judul: "Berserk of Gluttony", // Judul diubah
      keyword: "berserk",
    ...
    {
      judul: "Boku no Kanojo Sensei", // Judul diubah
      keyword: "boku",
  ...
  "C": [
    ...
    {
      judul: "Choppiri Toshiue Demo Kanojo", // Judul diubah
      keyword: "choppiri",
    ...
    {
      judul: "Chounin A wa Akuyaku", // Judul diubah
      keyword: "chounin",
     ...
     {
      judul: "Classroom of the Elite", // Judul diubah
      keyword: "classroom",
  ...
  "D": [
    {
      judul: "Danjo no Yuujou wa Seiritsu", // Judul diubah
      keyword: "danjo",
      genre: "Comedy, Romance, School",
    ...
    {
      judul: "Disciple of the Lich:", // Judul diubah
      keyword: "disciple",
    ...
    {
      judul: "Dokuzetsu Kuudere Bishoujo", // Judul diubah
      keyword: "dokuzetsu",
      genre: "Comedy, Romance",
    ...
    {
      judul: "Dungeon ni Deai wo Motomeru", // Judul diubah
      keyword: "dungeon",
    ...
    {
      judul: "Dungeon no Nai Sekai", // Judul diubah
      keyword: "dungeon",
  ...
  "E": [
    {
      judul: "Ecstas Online", // Judul diubah
      keyword: "ecstas",
    ...
    {
        judul: "Eighty-Six (Delapan-Enam) – 86", // Judul diubah
        keyword: "eighty-six",
    ...
    {
      judul: "Eromanga Sensei", // Judul diubah
      keyword: "eromanga",
    ...
    {
      judul: "Evil avalon", // Judul diubah
      keyword: "evil",
  ...
  "F": [
    ...
    {
      judul: "Free Life Fantasy Online:", // Judul diubah
      keyword: "free",
    ...
    {
      judul: "Fushi no Kami", // Judul diubah
      keyword: "fushi",
  ...
  "G": [
    {
      judul: "Gakusen Toshi Asterisk", // Judul diubah
      keyword: "gakusen",
    ...
    {
      judul: "Genjitsu Shugi Yuusha no Oukoku", // Judul diubah
      keyword: "genjitsu",
    ...
    {
      judul: "Gimai Seikatsu", // Judul diubah
      keyword: "gimai",
    ...
    {
      judul: "Goblin Slayer", // Judul diubah
      keyword: "goblin",
  ...
  "H": [
    {
      judul: "Hai to Gensou no Grimgar", // Judul diubah
      keyword: "hai",
    ...
    {
      judul: "Hataraku Maou-sama!", // Judul diubah
      keyword: "hataraku",
    ...
    {
      judul: "Hazure Skill [Guild Member]", // Judul diubah
      keyword: "hazure",
      genre: "Action, Adventure, Fantasy, Sci-Fi",
    ...
    {
      judul: "Hige wo Soru. Soshite", // Judul diubah
      keyword: "hige",
    ...
    {
      judul: "High School DxD", // Judul diubah
      keyword: "high",
    ...
    {
      judul: "Hikawa-sensei wants an otaku", // Judul diubah
    ...
    {
      judul: "Hikikomori Kyuuketsuki no Monmon", // Judul diubah
      keyword: "hikikomori",
    ...
    {
      judul: "Hitoribocchi no Isekai Kouryaku", // Judul diubah
    ...
    {
      judul: "Houkago no Seijo", // Judul diubah
      keyword: "houkago",
  ...
  "I": [
    ...
    {
      judul: "Incubus Banishment", // Judul diubah
      keyword: "incubus",
      genre: "Fantasy",
    ...
    {
      judul: "Infinite Dendrogram", // Judul diubah
      keyword: "infinite",
    ...
    {
      judul: "Inkya no Boku ni Batsu", // Judul diubah
      keyword: "inkya",
      genre: "Comedy, Romance, School",
    ...
    {
      judul: "Isekai Maou to Shoukan", // Judul diubah
      keyword: "isekai",
    ...
    {
      judul: "Isekai Nonbiri Nouka", // Judul diubah
      keyword: "isekai",
    ...
    {
      judul: "Isekai wa Heiwa deshita", // Judul diubah
      keyword: "isekai",
      genre: "Comedy, Fantasy, Slice of Life",
    ...
    {
      judul: "Isekai wa Smartphone to", // Judul diubah
      keyword: "isekai",
    ...
    {
      judul: "I’m the Evil Lord", // Judul diubah
      keyword: "i’m",
  ...
  "J": [
    {
      judul: "Jaku-chara Tomozaki-kun", // Judul diubah
      keyword: "jaku-chara",
      genre: "Comedy, Romance, School",
  ...
  "K": [
    {
      judul: "Kage no Jitsuryokusha ni", // Judul diubah
      keyword: "kage",
    ...
    {
      judul: "Kami wa Game ni Ueteiru", // Judul diubah
      keyword: "kami",
      genre: "Game",
    ...
    {
      judul: "Kawaii Onnanoko ni Kouryaku", // Judul diubah
      keyword: "kawaii",
      genre: "Comedy, Romance",
    ...
    {
      judul: "Kawaikereba Hentai demo Suki", // Judul diubah
      keyword: "kawaikereba",
    ...
    {
      judul: "Kimi to Boku no Saigo", // Judul diubah
      keyword: "kimi",
    ...
    {
      judul: "Kokoro Connect", // Judul diubah
      keyword: "kokoro",
    ...
    {
      judul: "Kokugensou wo Item Cheat", // Judul diubah
      keyword: "kokugensou",
      genre: "Action, Adventure, Fantasy, Isekai",
    ...
    {
      judul: "Kono Subarashii Sekai ni", // Judul diubah
      keyword: "kono",
    ...
    {
      judul: "Kou 2 ni Time Leaped", // Judul diubah
      keyword: "kou",
    ...
    {
      judul: "Kumo desu ga, Nani", // Judul diubah
      keyword: "kumo",
      genre: "Adventure, Fantasy, Isekai",
    ...
    {
      judul: "Kurasu No Daikiraina Joshi", // Judul diubah
      keyword: "kurasu",
      genre: "Comedy, Romance, School",
    ...
    {
      judul: "Kuro no Shoukanshi", // Judul diubah
      keyword: "kuro",
      genre: "Action, Adventure, Fantasy, Isekai",
  ...
  "L": [
    {
      judul: "Last Round Arthurs", // Judul diubah
      keyword: "last",
    ...
    {
      judul: "Lazy Dungeon Master", // Judul diubah
      keyword: "lazy",
      genre: "Fantasy",
    ...
    {
      judul: "Log Horizon", // Judul diubah
      keyword: "log",
  ...
  "M": [
    {
      judul: "Magic Knight of the", // Judul diubah
      keyword: "magic",
    ...
    {
      judul: "Magic Stone Gourmet: Eating", // Judul diubah
      keyword: "magic",
      genre: "Fantasy",
    ...
    {
      judul: "Mahouka Koukou No Rettousei", // Judul diubah
      keyword: "mahouka",
    ...
    {
      judul: "Majo no Tabitabi", // Judul diubah
      keyword: "majo",
      genre: "Adventure, Fantasy",
    ...
    {
      judul: "Make Heroine ga Oosugiru!", // Judul diubah
      keyword: "make",
      genre: "Comedy, Romance",
    ...
    {
      judul: "Mamahaha no Tsurego ga", // Judul diubah
      keyword: "mamahaha",
      genre: "Romance, Slice of Life",
    ...
    {
      judul: "Maou Gakuen no Hangyakusha", // Judul diubah
      keyword: "maou",
      genre: "Action, Fantasy, School",
    ...
    {
      judul: "Maou Gakuin no Futekigousha", // Judul diubah
      keyword: "maou",
      genre: "Action, Fantasy, School",
      sinopsis: "Dunia di mana Raja Iblis dan Pahlawan saling bermusuhan. Akademi Raja Iblis—sebuah institusi untuk Raja Iblis dan calon kader mereka. Orang yang berdiri di sana sebagai siswa pindahan adalah Raja Iblis Tirani, Anoth Voldigord—…tapi, setelah dua ribu tahun reinkarnasi, dia ternyata tidak cocok sebagai raja iblis!?"
    },
    {
      judul: "Maou ni Natta node,", // Judul diubah
      keyword: "maou",
      genre: "Fantasy, Slice of Life",
    ...
    {
      judul: "Mapping The Trash-Tier Skill", // Judul diubah
      keyword: "mapping",
      genre: "Adventure, Fantasy",
    ...
    {
      judul: "Masou Gakuen HxH", // Judul diubah
      keyword: "masou",
    ...
    {
      judul: "Megami no Yuusha wo Taosu", // Judul diubah
      keyword: "megami",
      genre: "Action, Adventure, Fantasy",
    ...
    {
      judul: "Mushoku Tensei", // Judul diubah
      keyword: "mushoku",
    ...
    {
      judul: "Musume Janakute, Watashi (Mama)", // Judul diubah
      keyword: "musume",
      genre: "Comedy, Romance",
    ...
    {
      judul: "My Gift LVL 9999", // Judul diubah
      keyword: "my gift",
      genre: "Fantasy, Isekai",
    ...
    {
      judul: "My Instant Death Ability Is", // Judul diubah
      keyword: "my instant",
      genre: "Action, Adventure, Fantasy, Isekai",
    ...
    {
      judul: "My Plain-looking Fiance is", // Judul diubah
  ...
  "N": [
    {
      judul: "Nageki no Bourei wa Intai", // Judul diubah
      keyword: "nageki",
      genre: "Adventure, Fantasy",
    ...
    {
      judul: "Nee-chan wa Chuunibyou", // Judul diubah
      keyword: "nee-chan",
    ...
    {
      judul: "Nidome no Yuusha wa Fukushuu", // Judul diubah
      keyword: "nidome",
    ...
    {
      judul: "No Game No Life", // Judul diubah
      keyword: "no game",
  ...
  "O": [
    {
      judul: "Omiai Shitakunakatta Node", // Judul diubah
      keyword: "omiai",
      genre: "Comedy, Romance, Slice of Life",
    ...
    {
      judul: "Omniscient Reader's Viewpoint", // Judul diubah
      keyword: "omniscient",
      genre: "Action, Adventure, Fantasy",
    ...
    {
      judul: "Ore ni Trauma wo Ataeta", // Judul diubah
      keyword: "ore ni",
      genre: "Comedy, Romance",
    ...
    {
      judul: "Ore no Shibou Flag ga", // Judul diubah
      keyword: "ore no",
      genre: "Comedy, Fantasy, Romance",
    ...
    {
      judul: "Otome Game no Heroine de", // Judul diubah
      keyword: "otome",
      genre: "Fantasy, Isekai",
    ...
    {
      judul: "Otonari Asobi", // Judul diubah
      keyword: "otonari",
      genre: "Comedy, Romance, Slice of Life",
    ...
    {
      judul: "Otonari no Tenshi-sama ni", // Judul diubah
      keyword: "otonari",
      genre: "Romance, Slice of Life",
    ...
    {
      judul: "Ousama no Propose", // Judul diubah
      keyword: "ousama",
      genre: "Fantasy, Romance",
  ...
  "P": [
    {
      judul: "Psycho Love Comedy", // Judul diubah
      keyword: "psycho",
  ...
  "R": [
    {
      judul: "Rakudai Kishi no Cavalry", // Judul diubah
      keyword: "rakudai",
    ...
    {
      judul: "Re:Zero kara Hajimeru Isekai", // Judul diubah
      keyword: "re:zero",
    ...
    {
      judul: "Reborn as a Space Mercenary:", // Judul diubah
      keyword: "reborn",
    ...
    {
      judul: "Reign of the Seven", // Judul diubah
      keyword: "reign",
    ...
    {
      judul: "Rokudenashi Majutsu Koushi to", // Judul diubah
      keyword: "rokudenashi",
    ...
    {
      judul: "Ryoushin no Shakkin wo Katagawari", // Judul diubah
      keyword: "ryoushin",
      genre: "Comedy, Romance, Slice of Life",
  ...
  "S": [
    {
      judul: "Saenai Heroine no Sodatekata", // Judul diubah
      keyword: "saenai",
    ...
    {
      judul: "Saijaku Muhai No Bahamut", // Judul diubah
      keyword: "saijaku",
      genre: "Action, Ecchi, Fantasy, Harem, Mecha, Romance, School",
    ...
    {
      judul: "Saijaku Tamer wa Gomi", // Judul diubah
      keyword: "saijaku",
      genre: "Adventure, Fantasy",
    ...
    {
      judul: "Sakurasou no Pet na", // Judul diubah
      keyword: "sakurasou",
      genre: "Comedy, Drama, Romance, School, Slice of Life",
    ...
    {
      judul: "Seiken Gakuin no Maken", // Judul diubah
      keyword: "seiken",
    ...
    {
      judul: "Seirei Gensouki", // Judul diubah
      keyword: "seirei",
      genre: "Fantasy, Romance, Isekai",
    ...
    {
      judul: "Seirei Tsukai no Blade", // Judul diubah
      keyword: "seirei",
    ...
    {
      judul: "Seishun Buta Yarou wa", // Judul diubah
      keyword: "seishun",
    ...
    {
      judul: "Sekai Saikou no Ansatsusha,", // Judul diubah
      keyword: "sekai",
      genre: "Action, Fantasy, Isekai",
    ...
    {
      judul: "Shijou Saikyou no Daimaou,", // Judul diubah
      keyword: "shijou",
    ...
    {
      judul: "Solo Leveling", // Judul diubah
      keyword: "solo",
    ...
    {
      judul: "Sono mono. Nochi ni...", // Judul diubah
      keyword: "sono",
      genre: "Fantasy, Isekai",
    ...
    {
      judul: "Spy Kyoushitsu", // Judul diubah
      keyword: "spy",
    ...
    {
      judul: "Strike the Blood", // Judul diubah
      keyword: "strike",
    ...
    {
      judul: "Sword Art Online", // Judul diubah
      keyword: "sword",
  ...
  "T": [
    {
      judul: "Taking My Reincarnation One", // Judul diubah
      keyword: "taking",
      genre: "Adventure, Fantasy, Isekai",
    ...
    {
      judul: "Tantei wa mou Shindeiru", // Judul diubah
      keyword: "tantei",
    ...
    {
      judul: "Tate no Yuusha no", // Judul diubah
      keyword: "tate",
      genre: "Action, Adventure, Fantasy, Isekai",
    ...
    {
      judul: "Tearmoon Teikoku Monogatari ~Dantoudai", // Judul diubah
      keyword: "tearmoon",
      genre: "Fantasy",
    ...
    {
      judul: "Tensai Ouji no Akaji Kokka", // Judul diubah
      keyword: "tensai",
      genre: "Fantasy",
    ...
    {
      judul: "Tensei Kizoku no Isekai", // Judul diubah
      keyword: "tensei",
      genre: "Fantasy, Isekai",
    ...
    {
      judul: "Tensei Oujo to Tensai", // Judul diubah
      keyword: "tensei",
    ...
    {
      judul: "Tensei shitara Slime Datta", // Judul diubah
      keyword: "tensei",
    ...
    {
      judul: "The Demon Prince Goes", // Judul diubah
      keyword: "the demon",
      genre: "Fantasy, School",
    ...
    {
      judul: "The New Gate", // Judul diubah
      keyword: "the new",
      genre: "Action, Adventure, Fantasy, Game",
    ...
    {
      judul: "The Unexplored Summon Blood-Sign", // Judul diubah
    ...
    {
      judul: "The World Otome Games/Trapped", // Judul diubah
      keyword: "the world",
      genre: "Fantasy, Isekai, Romance",
    ...
    {
      judul: "Tokidoki Bosotto Russia-go de", // Judul diubah
      keyword: "tokidoki",
      genre: "Comedy, Romance, School",
    ...
    {
      judul: "Tomodachi no Imouto ga", // Judul diubah
      keyword: "tomodachi",
      genre: "Comedy, Romance",
    ...
    {
      judul: "Torture Princess: Fremd Torturchen", // Judul diubah
      keyword: "torture",
    ...
    {
      judul: "Tsuki ga Michibiku Isekai", // Judul diubah
      keyword: "tsuki",
  ...
  "U": [
    {
      judul: "Uchi no Musume no", // Judul diubah
      keyword: "uchi",
      genre: "Fantasy, Slice of Life",
    ...
    {
      judul: "Ultimate Antihero", // Judul diubah
      keyword: "ultimate",
      genre: "Action, Fantasy",
    ...
    {
      judul: "Unnamed Memory", // Judul diubah
      keyword: "unnamed",
      genre: "Fantasy, Romance",
    ...
    {
      judul: "Urasekai Picnic", // Judul diubah
      keyword: "urasekai",
    ...
    {
      judul: "Utsuro no Hako to", // Judul diubah
      keyword: "utsuro",
  ...
  "V": [
    {
      judul: "Villainess Level 99: I", // Judul diubah
      keyword: "villainess",
  ...
  "Y": [
    ...
    {
      judul: "Yondome wa Iyana Shi", // Judul diubah
      keyword: "yondome",
      genre: "Fantasy, Isekai",
    ...
    {
      judul: "Youjo Senki", // Judul diubah
      keyword: "youjo",
    ...
    {
      judul: "Your and My Asylum", // Judul diubah
      keyword: "your",
      genre: "Drama, Romance",
    ...
    {
      judul: "Yujin Kyara wa Taihen", // Judul diubah
      keyword: "yujin",
      genre: "Comedy, Romance",
    ...
    {
      judul: "Yumemiru Danshi wa Genjitsushugisha", // Judul diubah
      keyword: "yumemiru",
      genre: "Romance, Slice of Life",
    ...
    {
      judul: "yuusha ni horobosareru dake", // Judul diubah
      keyword: "yuusha",
