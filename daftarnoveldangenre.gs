...
function getMenuGenreNovelKeyboard() {
  ...
  keyboard.inline_keyboard.push([{ text: "Kembali ke Menu Novel 🤡", callback_data: "daftar_novel" }]); // Tombol kembali ke menu novel A-Z
  return keyboard;
}
...
function getNovelListKeyboardByGenre(genre) {
  ...
  tombolNovel.push([{ text: "Kembali ke Menu Genre 🤡", callback_data: "novel_genre_menu" }]); // Tombol kembali ke menu genre
...
      ],
      [
        { text: "Genre 🎭", callback_data: "novel_genre_menu" }, // Tambah menu genre
      ],
      [
...
function showNovelGenreMenu(chatId, messageId) {
  let menuText = "<b>🎭 Daftar Genre Novel - Pilih Genre Kegelapan...</b>\n\n<i>Telusuri genre untuk menemukan kisah berdasarkan kategori... 🖤</i>";
